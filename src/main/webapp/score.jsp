...
String q="SELECT u.user_id,u.username, u.user_type,COUNT(q1.question_id) AS total_attempted, SUM(CASE WHEN q1.chosen_option = q2.correct_option THEN 1 ELSE 0 END) AS score FROM users u LEFT JOIN quiz_attempts q1 ON u.user_id = q1.user_id LEFT JOIN questions q2 ON q1.question_id = q2.id where user_type='"+usr_type+"' GROUP BY u.user_id, u.username;";
